...
struct timeval tick_send_image;
...
//void send_image(coap_context_t *ctx,coap_session_t *session, timeval *tick);
...
void send_image(coap_context_t *ctx,coap_session_t *session, struct timeval *tick) {
...
//     coap_context_set_csm_max_message_size(ctx, csm_max_message_size);
  ...
  // //repeat_count--;
  send_image(ctx,session, &tick_send_image);
